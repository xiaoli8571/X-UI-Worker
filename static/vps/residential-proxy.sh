#!/usr/bin/env bash
# ==========================================================
# X-UI 住宅IP代理 Agent 安装脚本 (Residential Proxy Agent)
# 用法:
#   bash <(curl -sL https://<X-UI_PAGES>/vps/residential-proxy.sh) \
#        --domain https://<X-UI_PAGES> --controller https://<RESIDENTIAL_CTRL>
#   --domain      : 本仓库 (X-UI Pages) 域名，用于下载 /vps/ 下的 agent 脚本
